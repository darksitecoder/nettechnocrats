            	...
            	<div class="row">
                	<div class="col-xs-12">
                    	<div class="text-center">                            
                            <h1 class="python_heading">PhoneGap <font> Development Services</font> </h1>
                            
                            <h4>Create cross-platform mobile apps for <font>iOS and Android with PhoneGap</font></h4>                         
                ...
                <div class="row top_margin">
                    <div class="col-md-4 col-xs-12">
                        <div class="pytn_box first">
                            ...
                            <img src="https://s3.us-east-2.amazonaws.com/nettech-images/paytn1.png">
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="pytn_box sec">
                            ...
                            <img src="https://s3.us-east-2.amazonaws.com/nettech-images/python-icon.png">
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="pytn_box third">
                            <h1>PhoneGap Developer</h1>
                            <img src="https://s3.us-east-2.amazonaws.com/nettech-images/paythonicon3.png">
                            <h5>We create developer mobile apps to offer you a quick view of your app that how it looks and works. Doing this provides a confidence to you that your app will work in the exact way as you wanted. </h5>
                        </div>
                    </div>
                    <div class="col-md-4 col-xs-12">
                        <div class="pytn_box first">
                            ...
                            <img src="https://s3.us-east-2.amazonaws.com/nettech-images/paythonicon4.png">
                    ...
                    <div class="col-md-4 col-xs-12">
                        <div class="pytn_box sec">
                            ...
                            <img src="https://s3.us-east-2.amazonaws.com/nettech-images/paythonicon9.png">
                   ...
                   <div class="col-md-4 col-xs-12">
                        <div class="pytn_box third">
                            ...
                            <img src="https://s3.us-east-2.amazonaws.com/nettech-images/paythonicon6.png">
 ...
 <section id="paython1" class="paython2">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="text-center">                            
                    <h2 class="python_heading">Why Choose Our Phonegap<font> Development Services?</font> </h2>
