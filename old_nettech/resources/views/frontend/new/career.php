...
<div class="container">
    ...
    <div class="col-md-12">
      ...
      <ul class="list-inline carrer-list">
      	<li>
        	<div class="career-head"><h5>Android Developers</h5></div>
...
<div class="join_team"> <a href="/contact.php">Contact Us</a> </div>
        ...
        <li>
        	<div class="career-head"><h5>Blockchain Developer</h5></div>
<div class="career-detail">
<h6>Noida</h6>
<p>1-4 Years expr</p>
<div class="join_team"> <a href="/contact.php">Contact Us</a> </div>
        ...
        <li>
        	<div class="career-head"><h5>Python Developers</h5></div>
<div class="career-detail">
<h6>Noida</h6>
<p>1-4 Years expr</p>
<div class="join_team"> <a href="/contact.php">Contact Us</a> </div>
        ...
        <li>
        	<div class="career-head"><h5>Angular JS Developer</h5></div>
<div class="career-detail">
<h6>Noida</h6>
<p>1-5 Years expr</p>
<div class="join_team"> <a href="/contact.php">Contact Us</a> </div>
        ...
        <li>
        <div class="career-head"><h5>PHP Developers</h5></div>
<div class="career-detail">
<h6>Noida</h6>
<p>1-3 Years expr</p>
<div class="join_team"> <a href="/contact.php">Contact Us</a> </div>
