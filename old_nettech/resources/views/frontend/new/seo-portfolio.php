...
<div class="mark-sec-1">
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
          <div class="marketing_section_image">   
            <img src="images/marketingadventure.png" alt="">        
                        <div class="inisde_image"><img src="images/reput.png" alt=""></div>
            <div class="seo-arrow"><img src="images/seo-arrow.png" alt=""></div>
          </div>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
      ...
      <div class="mark-sec-1">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
          <div class="marketing_section_image">
            <img src="images/marketingadventure.png" alt="Get Rank First">
                        <div class="inisde_image"><img src="https://www.getrankfirst.com/resources/assets/seoimage/download.jpg" alt=""></div>
            <div class="seo-arrow2"><img src="images/seo-arrow2.png" alt=""></div>
          </div>
        </div>
      </div>
      <div class="mark-sec-1">
