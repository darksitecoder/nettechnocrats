...
$sql = "select * from portfolios_new where 1"; 
if($technology!='')
{
...
$sql .= " LIMIT ".$start." , ".$numofrecords." ";

$query = mysqli_query($conn,$sql); 

$sql2 = "select * from portfolios_new  where 1";
if($technology!='')
{
    $sql2 .= " and technology = ".$technology." ";
}
if($industry!='')
{
  ...
  <div class="col-lg-3 col-sm-6 col-xs-12 paddinglr custom-web-grid" id="web_grid_65">
   <div class="mobile-porfolio-grid">
      <div class="col-sm-12 text-center">
         <div class="mobile-client-logo"> <img src="<?php echo 'https://s3.ap-south-1.amazonaws.com/portfoliopro/'.$fetch_member_data['logo'];?>" alt="portfolios/<?php echo $fetch_member_data['logo'];?>"> </div>
      </div>
      <div class="col-sm-12">
         <div class="mobile-client-name"> <img src="<?php echo 'https://s3.ap-south-1.amazonaws.com/portfoliopro/'.$fetch_member_data['banner'];?>" alt="portfolios/<?php echo $fetch_member_data['banner'];?>"> </div>
      </div>
         ...
         <div class="text-center">
            <div class="mobileproject-descrption">
               <div class="mobilep-des-info">
                  ...
                  <?php if($fetch_member_data['case_study'] == '') { ?> 
                         <div class="case-btn">
                            <a href="javascript:void(0)">Case Study</a>
                          </div>
                  <?php }else { ?>
                       <div class="case-btn">
                            <a target="_blank" href="<?php echo $fetch_member_data['case_study']; ?>">Case Study</a>
                          </div>
