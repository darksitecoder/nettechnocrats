...
<section class="top_banner">
  <div class="inner_banner_area"> <img class="innr_bnr_img" src="images/ui_ux_design_banner.jpg" alt="">
...
<div class="container">
    <div class="row ">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <p class="font-19 text-center">We just don't develop creative and innovate web and mobile app, we also design them.</p>
      </div>
    </div>
    <div class="row technology-bot">
      <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
        <div class="technology-description ui-tech-description">
    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="development-box">
          <h3>UI (User Interface) Development </h3>
          <p>We put our best effort to deliver fully functional web application design. We mix your and our ideas and build a unique architectural web application design which is convenient from the user end. Not only the web design services but also we are responsible for the convenient user-end interface.</p>
        </div>
      </div>
    </div>
    <div class="row">
