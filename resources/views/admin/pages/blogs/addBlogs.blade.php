      ...
      <main class="content">
        ...
        <div class="row pt-1 my-3 d-flex justify-content-center">
          ...
          <div class="col-md-12 stretch-card grid-margin mb-3">
            <input type="text" id="seo_title" name="seo_title" class="blog__company_name input__feilds" value="{{ old('seo_title') }}" placeholder="Enter SEO title">
            @error('seo_title')
              <span class="text-danger" style="font-size:13px;">{{ $message }}</span>
            @enderror
          </div>
          ...
          <div class="col-md-12 stretch-card grid-margin">
            <input type="text" id="seo_decription" name="seo_decription" class="blog__company_name input__feilds"  value="{{ old('seo_decription') }}" placeholder="Enter SEO meta decription">
