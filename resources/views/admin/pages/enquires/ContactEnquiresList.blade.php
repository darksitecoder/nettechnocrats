...
<body>
                    ...
                    <tr>
                      ...
                      <td class="d-none d-md-table-cell">
                        <button
                          ...
                          data-massage="{{ $data->requirement }}">
                          View enquiry <i class="fa-regular fa-eye"></i>
                        </button>
                      </td>
                      <td class="d-none d-md-table-cell">
                        <a href="{{ url('deleteContactEnquiriesForAdmin/'.$data->id) }}">
    ...
    <div class="modal-content">
      ...
      <table>
        ...
        <tr>
          ...
          <td id="modal-company-website"></td>
        </tr>
        <tr>
          <th>Project Title</th>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      // Event delegation for dynamically generated .trigger buttons
      document.addEventListener('click', (event) => {
        ...
        if (button) {
          ...
          document.getElementById('modal-company-size').textContent = button.getAttribute('data-company_size');
          document.getElementById('modal-company-name').textContent = button.getAttribute('data-company_name');
          document.getElementById('modal-company-website').textContent = button.getAttribute('data-company_website');
          document.getElementById('modal-project-title').textContent = button.getAttribute('data-project_title');
          document.getElementById('modal-message').textContent = button.getAttribute('data-massage');
