    ...
    <div class="row pt-4">
        <div class="col-lg-3">
            ...
            <div class="social__media__icons pt-3">
                <a href="https://www.facebook.com/Nettechnocrats.it.services" target="_blank"><i class="fa-brands fa-facebook"></i></a>
                <a href="https://twitter.com/nettechnocrats" target="_blank"><i class="fa-brands fa-twitter"></i></a>
                <!-- <a href="#"><i class="fa-brands fa-pinterest"></i></a> -->
                <a href="https://www.instagram.com/nettechnocrats/" target="_blank"><i class="fa-brands fa-instagram"></i></a>
                <a href="https://www.linkedin.com/company/nettechnocrats/" target="_blank"><i class="fa-brands fa-linkedin"></i></a>
            </div>
        </div>
        <div class="col-lg-3">
            <h5>CLIENT 1ST</h5>
            <img src="{{ asset('assets/web/footer-images/client-partners-verified-300x91-1.webp') }}" alt="" srcset="" style="width:200px;">
        </div>
        <div class="col-lg-6">
            <h5>PARTNER & CERTIFICATIONS</h5>
            <div class="certificates">
                <div class="row">
                    <div class="col-lg-3"><img src="{{ asset('assets/web/footer-images/google_certified.webp') }}" alt="" srcset=""></div>
                    <div class="col-lg-3"><img src="{{ asset('assets/web/footer-images/9001_certified.webp') }}" alt="" srcset=""></div>
                    <div class="col-lg-3"><img src="{{ asset('assets/web/footer-images/amazon_services.webp') }}" alt="" srcset=""></div>
                    <div class="col-lg-3"><img src="{{ asset('assets/web/footer-images/paypal.webp') }}" alt="" srcset=""></div>
                </div>
            </div>
        </div>
    </div>
