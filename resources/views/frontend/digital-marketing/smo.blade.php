       ...
       <p>SEO marketing is all about getting rank on the search engine results which will help the website attract a lot of traffic and eventually convert them into leads and sales. </p>
            ...
            <section id="about" class="about section">
                  ...
                  <div class="container section-title" data-aos="fade-up">
                        ...
                        <h2><strong>Social Media Marketing Services</strong></h2>
                        <p>Get in Touch SMO Company Hire Social media experts to increase brand awareness and loyalty Social Media Marketing Services Stimulate brand recognition across the Internet by hiring a leading social media marketing agency</p>
                  ...
                  <div class="py-4" style="background-color: rgba(50,197,181,0.2);">
                        <div class="row gy-4 py-5" style="background: url('{{ asset('assets/web/dot-shape.png') }}');">
                              <div class="col-lg-12 order-2 order-lg-1 d-flex flex-column justify-content-center px-5" data-aos="fade-up">
                                    ...
                                    <p class="text-center px-5">Our social media marketing agency is backed by a pool of social media experts who always keep themselves abreast with all the latest SMO updates and technologies to serve you the best way. They understand your need for smart and innovative marketing strategies and help you with your potential audience, through custom effective SMO campaigns.</p>
                                    <p class="text-center px-5">If you're looking for string goodwill in the market and a big customer fan base over social media, hire social media marketer from us and explore niche markets, generate more traffic, and increase your website visibility- in a nutshell, raise your business heights.</p>
                        ...
                        <div class="row justify-content-center" data-aos="zoom-in" data-aos-delay="100">
                              <div class="col-xl-10">
                                    <div class="text-center">
                                          ...
                                          <p><strong>Stay ahead from Crowd. We have an expert team of application developers who are experienced and proficient. We have good experience in bespoke web and mobile app development and are committed to delivering the best of the class solutions.</strong></p>
