   ...
   <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
    <div class="col-xl-7 wow fadeInLeft">
     <div>
      ...
      <h1 class="display-5 mb-4 text-white">Media & Entertainment Software Solutions</h1>
      <p class="mb-4 text-white">Deliver rich experience through our Media and entertainment solutions</p>
     </div>
    </div>
    <div class="col-xl-5 wow fadeInRight" data-wow-delay="0.2s">
     <div class=" rounded position-relative overflow-hidden  d-flex justify-content-center">
      <img src="{{ asset('assets/web/media.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="News Website Development Company">
 ...
 <div class="container-fluid about py-5">
  <div class="container py-5">
   ...
   <div class="text-center mx-auto pb-5 wow fadeInUp" data-aos="fade-up" data-aos-delay="100">
    <h2 class="display-5 mb-4">Powerful IT Solutions For Media and Entertainment to build engaging customer experience</h2>
   </div>
   <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
     <div class="rounded position-relative overflow-hidden">
      <img src="{{ asset('assets/web/media-nettehcnocrats.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="News Website Development Company">
   ...
   <div class="row g-4">
    ...
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       <a href="#" class="h4 d-inline-block mb-4">WEBSITE CREATION</a>
       <p class="mb-4">To make your place on the web, the team of skilled professionals at Nettechnocrats put their efforts in website designing and creation. They make sure that the ultimate website is designed, coded so that it can run flawlessly on the web.</p>
       <!-- <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a> -->
      </div>
     </div>
    </div>
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       <a href="#" class="h4 d-inline-block mb-4">OTHER SERVICES</a>
    ...
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       <a href="#" class="h4 d-inline-block mb-4">MUSIC</a>
       <p class="mb-4">Today the music industry is lying more towards online channels to reach a large pool of audience. We enable you to participate in this digital revolution, by offering music streaming app for iPhone and Android both. if you have a music streaming app idea in mind, come to us to avail the best music streaming app development service.</p>
      </div>
     </div>
    </div>
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       <a href="#" class="h4 d-inline-block mb-4">PRINT & PUBLISHING</a>
       <p class="mb-4">The print and publishing industry has undergone a dramatic change due to the digital media revolution. With the emergence of Smartphone and next-generation devices, it is more common for publishing works to be accessed digitally. Our software suite helps our clients in print media to deliver information and content on-the-go to their users worldwide.</p>
      </div>
     </div>
    </div>
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
   ...
   <div class="row pt-2">
    ...
    <div class="col-lg-6 content d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
     <div class="seo__animation__gifs">
      <div class="rounded position-relative overflow-hidden">
       <img src="{{ asset('assets/web/media-nettechnocrats.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="Media Website Development Company">
