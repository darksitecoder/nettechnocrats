  ...
  <script type="application/ld+json" class="yoast-schema-graph">
    {
      ...
      "@graph": [{
        "@type": "WebPage",
        "@id": "https://www.nettechnocrats.com/social-media-marketing-services/",
        "url": "https://www.nettechnocrats.com/social-media-marketing-services/",
        "name": "Top Social Media Marketing Agency in India",
        "isPartOf": {
          "@id": "/#website"
        },
        "primaryImageOfPage": {
          "@id": "https://www.nettechnocrats.com/social-media-marketing-services/#primaryimage"
        },
        "image": {
          "@id": "https://www.nettechnocrats.com/social-media-marketing-services/#primaryimage"
        },
        "thumbnailUrl": "https://www.nettechnocrats.com/wp-content/uploads/2023/10/social-media-marketing-services-banner.webp",
        "datePublished": "2023-10-16T10:10:55+00:00",
        "dateModified": "2024-08-13T11:19:55+00:00",
        "description": "We are top Social Media Marketing Agency offer paid services to increase the brand brand visibility, engagement, and conversions.",
        "breadcrumb": {
          "@id": "https://www.nettechnocrats.com/social-media-marketing-services/#breadcrumb"
        },
        "inLanguage": "en-US",
        "potentialAction": [{
          "@type": "ReadAction",
          "target": ["https://www.nettechnocrats.com/social-media-marketing-services/"]
        }]
      }, {
        "@type": "ImageObject",
        "inLanguage": "en-US",
        "@id": "https://www.nettechnocrats.com/social-media-marketing-services/#primaryimage",
        "url": "https://www.nettechnocrats.com/wp-content/uploads/2023/10/social-media-marketing-services-banner.webp",
        "contentUrl": "https://www.nettechnocrats.com/wp-content/uploads/2023/10/social-media-marketing-services-banner.webp",
        "width": 859,
        "height": 795
      }, {
        "@type": "BreadcrumbList",
      ...
      <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
        <div class="col-xl-7 wow fadeInLeft">
          <div>
            ...
            <h1 class="display-5 mb-4 text-white">Social Media Marketing
              Services</h1>
            <p class="mb-4 text-white">Tell Your Special Brand Story with the Help of a Social Media Marketing Agency</p>
          </div>
        </div>
        <div class="col-xl-5 wow fadeInRight" data-wow-delay="0.2s">
          <div class=" rounded position-relative overflow-hidden  d-flex justify-content-center">
            <img src="{{ asset('assets/web/sharepoint.webp') }}" class="img-fluid rounded " alt="Social Media Marketing Agency">
  ...
  <div class="container-fluid about py-5">
    <div class="container py-5">
      ...
      <div class="text-center mx-auto pb-5 wow fadeInUp" data-aos="fade-up" data-aos-delay="100">
        <h2 class="display-5 mb-4">Mastering Social Media Marketing: Your Path to Success</h2>
        <p>In the world of Social Media Marketing Services, your company’s narrative takes center stage. It’s about sharing your story where it matters most.</p>
      </div>
      <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
        <div class="col-xl-6 wow fadeInLeft">
          <div>
            <!-- <h4 class="text-primary1">About Us</h4> -->
            <p class="mb-4 fw-bold fs-3">Why Social Media Matters?</p>
            <p class="mb-4">Around 4.57 billion people use social media worldwide, and a whopping 346 million joined in just 2020. These platforms are now the primary sources for news and chats.</p>
            <p class="mb-4">
            <ol>
              <li>Social media is getting more popular, so learning how to use it for marketing is important.</li>
              <li>Some people start without knowing how it works, but you don’t have to be one of them.</li>
              <li>Our Social Media Marketing Specialists can show you the way, whether you’re in B2C (business-to-consumer) or B2B (business-to-business).</li>
            </ol>
            </p>
            <p class="mb-4">At Nettechnocrats, we help you to understand popular social media platforms and how to get benefits from these platforms.</p>
        ...
        <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
          <div class="rounded position-relative overflow-hidden">
            <img src="{{ asset('assets/web/sharepoint1.webp') }}" class="img-fluid rounded w-100" alt="SMM Agency in India">
      ...
      <div class="row pt-2">
        ...
        <div class="col-lg-6 content d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
          <div class="seo__animation__gif">
            <div class="rounded position-relative overflow-hidden">
              <img src="{{ asset('assets/web/SharePoint-migration.webp') }}" class="img-fluid rounded w-100" alt="Social Media Marketing Agency">
