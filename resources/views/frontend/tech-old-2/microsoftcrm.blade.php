            ...
            <div class="col-xl-7 wow fadeInRight" data-wow-delay="0.4s">
                <div class="tab-content">
                    <div id="collapseOne" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                            <div class="col-md-12">
                                <h2 class="display-5 mb-4">User-friendly</h2>
                    ...
                    <div id="collapseTwo" class="tab-pane fade show p-0">
                        <div class="row g-4">
                            <div class="col-md-12">
                                <h2 class="display-5 mb-4">Manage any relationship & process</h2>
                    ...
                    <div id="collapseThree" class="tab-pane fade show p-0">
                        <div class="row g-4">
                            <div class="col-md-12">
                                <h2 class="display-5 mb-4">Adaptive crm engine</h2>
                    ...
                    <div id="collapseFour" class="tab-pane fade show p-0">
                        <div class="row g-4">
                            <div class="col-md-12">
                                <h2 class="display-5 mb-4">Cost-flexibility</h2>
