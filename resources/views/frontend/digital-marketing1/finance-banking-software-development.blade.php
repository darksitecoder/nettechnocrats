...
<body>
   ...
   <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
    <div class="col-xl-6 wow fadeInLeft">
     <div>
      ...
      <h1 class="display-5 mb-4 text-black">Banking And Financial Solutions</h1>
      <p>Customer-centric banking and financial solutions to offer more personalized service and fuel business growth</p>
     </div>
     @include('partial/proposal')
    </div>
    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
     <div class=" rounded position-relative overflow-hidden  d-flex justify-content-center">
      <img src="{{ asset('assets/web/Finance-Banking-Software-Development_Main_Banner.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="Finance Banking Software Development">
 ...
 <div class="container-fluid about py-5">
  <div class="container py-5">
   ...
   <div class="text-center mx-auto pb-5 wow fadeInUp" data-aos="fade-up" data-aos-delay="100">
    ...
    <p>Quality IT solution-Their frameworks, tools, platforms developed with rich project experience help them deliver quality banking IT Solutions to the customers.</p>
    <p>Financial and banking companies can gain efficiency through high-quality service that is delivered on time, compiled with security, etc. Nettechnocrats always fulfill multiple IT needs for various banking and financial companies. Also, they bridge the gap in the market that sets them apart from other service providers by combining all banking and financial sector needs by creating flexible financial software.</p>
   </div>
  </div>
 </div>
 <!-- About End -->
 ...
 <div class="container-fluid service pb-5">
  <div class="container pb-5">
   <h3 class="fw-bold text-center fs-2 mb-5">The Banking Solutions We Provide</h3>
   <div class="row g-4">
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       <a href="#" class="h4 d-inline-block mb-4">Online Banking Solutions</a>
       <p class="mb-4">Banking and financial institutes are offering technology to serve their customers 24/7 with by providing them a platform to meet all their requirements. Our innovative online banking solutions allow our clients to serve their customers with engaging and interactive online web service.</p>
    ...
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       <a href="#" class="h4 d-inline-block mb-4">Mobile Wallet Banking</a>
       <p class="mb-4">We provide a robust platform to link consumer, banks, and merchant remotely through a strong and secure platform. We offer a fully-customized and feature-rich digital wallet app pr mobile payment wallet app or Android, iPhone and Wearable Devices.</p>
       <!-- <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a> -->
      </div>
     </div>
    </div>
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       <a href="#" class="h4 d-inline-block mb-4">Finance & Accounting Software</a>
       <p class="mb-4">Whether you have a small or big enterprise, you need to deal with a large amount of financial information on a regular basis. We offer you advanced and fully-integrated finance and accounting software that allows managing all the financial assets in a more efficient way.</p>
       <!-- <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a> -->
      </div>
     </div>
    </div>
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       <a href="#" class="h4 d-inline-block mb-4">Systems & Financial Planning Software</a>
       <p class="mb-4">Nettechnocrats helps different discretionary asset managers, private bankers, and family offices by offering custom financial planning system and software to create, sort, and report different types of financial transactions in a unified system.</p>
      </div>
     </div>
    </div>
   </div>
 ...
 <div class="container-fluid service pb-5">
  <div class="container pb-5">
   <h3 class="fw-bold text-center fs-2 mb-5">Essential Features Of Online Banking Solutions</h3>
   <div class="row g-4">
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
     <div class="service-item">
      <div class="service-img">
      ...
      <div class="rounded-bottom p-4">
       <a href="#" class="h4 d-inline-block mb-4">SIMPLE YET SECURE SIGN-IN</a>
       <p class="mb-4">Nettechnocrats play special attention to provide a completely secure banking solution to eliminate the possibility of any fraud. Our secure banking apps include a 2-factor identification used for registration, authentication, confirmation of transactions as well as pin change.</p>
       <!-- <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a> -->
      </div>
     </div>
    </div>
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       <a href="#" class="h4 d-inline-block mb-4">EASY ACCESS TO ACCOUNT INFORMATION</a>
       <p class="mb-4">Banks want consumers to be able to easily access their transaction history. While developing any banking app, our experts assure to make the user interface simple and easy to use that provide a secure and easy way for accessing their account information.</p>
       <!-- <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a> -->
      </div>
     </div>
    </div>
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       <a href="#" class="h4 d-inline-block mb-4">INTELLIGENT CHATBOT INTEGRATION</a>
       <p class="mb-4">Providing the most personalized session to clients is the first priority of any financial organization. We can also integrate a smart & intelligent chatbot that can easily answer hundreds of customers at the same time without making them wait in line.</p>
       <!-- <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a> -->
      </div>
     </div>
    </div>
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       <a href="#" class="h4 d-inline-block mb-4">ALERTS AND NOTIFICATIONS</a>
       <p class="mb-4">There is no need to define how important notifications are. Our experts provide an advanced solution that let you keep in touch with your customers, engage them, and promote your services effectively.</p>
      </div>
     </div>
    </div>
   </div>
 ...
 <section class="light-background why__choose__Net">
  <div class="container">
   <h2>Why Nettechnocrats for Online Banking Solutions?</h2>
    ...
    <div class="col-lg-6 content d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
     <div class="seo__animation__gifs">
      <div class="rounded position-relative overflow-hidden">
       <img src="{{ asset('assets/web/1655815539233.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="Finance Software Development">
