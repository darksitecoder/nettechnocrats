    ...
    <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "WebPage",
                "@id": "https://www.nettechnocrats.com/seo-for-real-estate/",
                "url": "https://www.nettechnocrats.com/seo-for-real-estate/",
                "name": "Real Estate SEO company, Real Estate SEO Services",
                "isPartOf": {
                    "@id": "/#website"
                },
                "primaryImageOfPage": {
                    "@id": "https://www.nettechnocrats.com/seo-for-real-estate/#primaryimage"
                },
                "image": {
                    "@id": "https://www.nettechnocrats.com/seo-for-real-estate/#primaryimage"
                },
                "thumbnailUrl": "https://www.nettechnocrats.com/wp-content/uploads/2023/08/local_seo_side.jpg",
                "datePublished": "2023-09-19T06:40:55+00:00",
                "dateModified": "2024-08-13T10:28:46+00:00",
                "description": "Are you struggling to get #1 ranking for your real estate business. Try SEO Services for Real Estate Business and enhance your online visibility.",
                "breadcrumb": {
                    "@id": "https://www.nettechnocrats.com/seo-for-real-estate/#breadcrumb"
                },
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
                    "target": ["https://www.nettechnocrats.com/seo-for-real-estate/"]
                }]
            }, {
                "@type": "ImageObject",
                "inLanguage": "en-US",
            ...
            <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
                <div class="col-xl-12 wow fadeInLeft">
                    <div class=" rounded d-flex justify-content-center">
                        <img src="{{ asset('assets/web/tech__background.webp') }}" class="img-fluid rounded" alt="Real Estate SEO company" style="width: 100%; height:300px; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div id="call-to-action" class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100" style=" background-color: var(-accent-color) !important;">
                ...
                <div class="col-xl-6 wow fadeInLeft">
                    <div>
                        ...
                        <img src="{{ asset('assets/web/progress.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="Real Estate SEO">
                    </div>
                </div>
