    ...
    <script type="application/ld+json" class="yoast-schema-graph">
        {
            ...
            "@graph": [{
                "@type": "WebPage",
                "@id": "https://www.nettechnocrats.com/sharepoint-migration/",
                "url": "https://www.nettechnocrats.com/sharepoint-migration/",
                "name": "SharePoint Migration Services | Microsoft SharePoint Migration Company",
                "isPartOf": {
                    "@id": "/#website"
                },
                "primaryImageOfPage": {
                    "@id": "https://www.nettechnocrats.com/sharepoint-migration/#primaryimage"
                },
                "image": {
                    "@id": "https://www.nettechnocrats.com/sharepoint-migration/#primaryimage"
                },
                "thumbnailUrl": "https://www.nettechnocrats.com/wp-content/uploads/2023/08/sharepoint_side_img.jpg",
                "datePublished": "2023-08-31T09:02:06+00:00",
                "dateModified": "2024-08-13T10:29:33+00:00",
                "description": "Partner with Microsoft SharePoint migration company for expert SharePoint migration services. Seamlessly move your data with confidence.",
                "breadcrumb": {
                    "@id": "https://www.nettechnocrats.com/sharepoint-migration/#breadcrumb"
                },
                "inLanguage": "en-US",
                "potentialAction": [{
                    "@type": "ReadAction",
                    "target": ["https://www.nettechnocrats.com/sharepoint-migration/"]
                }]
            }, {
                "@type": "ImageObject",
                "inLanguage": "en-US",
                "@id": "https://www.nettechnocrats.com/sharepoint-migration/#primaryimage",
                "url": "https://www.nettechnocrats.com/wp-content/uploads/2023/08/sharepoint_side_img.jpg",
                "contentUrl": "https://www.nettechnocrats.com/wp-content/uploads/2023/08/sharepoint_side_img.jpg",
                "width": 500,
                "height": 377,
                "caption": "SharePoint Migration"
            }, {
                "@type": "BreadcrumbList",
                "@id": "https://www.nettechnocrats.com/sharepoint-migration/#breadcrumb",
                "itemListElement": [{
            ...
            <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-xl-5 wow fadeInRight" data-wow-delay="0.2s">
                    <div class=" rounded position-relative overflow-hidden  d-flex justify-content-center">
                        <img src="{{ asset('assets/web/sharepoint.webp') }}" class="img-fluid rounded " alt="SharePoint Migration Services" style="width: 300px;">
    ...
    <div class="container-fluid about py-5">
        <div class="container py-5">
            ...
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-aos="fade-up" data-aos-delay="100" style="max-width: 800px;">
                <h2 class="display-5 mb-4">SharePoint Migration Services</h2>
            ...
            <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
                <div class="col-xl-6 wow fadeInLeft">
                    <div>
                        <!-- <h4 class="text-primary1">About Us</h4> -->
                        <p class="mb-4">A SharePoint is an easy to use system that enables your team and partners work together by accessing all the enterprise information and application on a single corporate network. With custom SharePoint development services, Nettechnocrats can help clients manage their business data, application, and information with utmost efficiency.
                        </p>
                        <div class="row g-4">
                ...
                <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
                    <div class="rounded position-relative overflow-hidden">
                        <img src="{{ asset('assets/web/sharepoint1.webp') }}" class="img-fluid rounded w-100" alt="SharePoint Migration">
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="service-item">
                        ...
                        <div class="rounded-bottom p-4">
                            <a href="#" class="h4 d-inline-block mb-4">DEPLOYMENT PLANNING SERVICES</a>
                            <p class="mb-4">Through planning services, our experts can help plan and manage an array of Microsoft software deployment solutions on-premises, in the cloud or hybrid environments.
                            </p>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                    <div class="service-item">
                        ...
                        <div class="rounded-bottom p-4">
                            <a href="#" class="h4 d-inline-block mb-4">CUSTOM WEBPARTS DEVELOPMENT</a>
                            <p class="mb-4">Our team of dedicated Microsoft SharePoint Developers provides a spectrum of custom web parts that enable users to find useful information and content easily and quickly.
                            </p>
                            <!-- <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a> -->
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="service-item">
                        ...
                        <div class="rounded-bottom p-4">
                            <a href="#" class="h4 d-inline-block mb-4">SITE BRANDING</a>
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="service-item">
                        ...
                        <div class="rounded-bottom p-4">
                            <a href="#" class="h4 d-inline-block mb-4">SITE MIGRATION</a>
                            <p class="mb-4">Site migration services can be a task for you. With our SharePoint site migration services, we help our clients to restructure the website content into new/existing site.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row pt-2">
                ...
                <div class="col-lg-6 content d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
                    <div class="seo__animation__gif">
                        <div class="rounded position-relative overflow-hidden">
                            <img src="{{ asset('assets/web/SharePoint-migration.webp') }}" class="img-fluid rounded w-100" alt="SharePoint Migration Services">
