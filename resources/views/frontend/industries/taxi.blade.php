...
<head>
      ...
      <meta property="og:image" content="https://www.nettechnocrats.com/wp-content/uploads/2023/09/main-taxi-1024x310-1.webp" />
      ...
      <script type="application/ld+json" class="yoast-schema-graph">
            {
                  ...
                  "@graph": [{
                        "@type": "WebPage",
                        "@id": "https://www.nettechnocrats.com/taxi-booking-app/",
                        "url": "https://www.nettechnocrats.com/taxi-booking-app/",
                        "name": "Taxi Booking App Development Company India & USA | Nettechnocrats",
                        "isPartOf": {
                              "@id": "/#website"
                        },
                        "primaryImageOfPage": {
                              "@id": "https://www.nettechnocrats.com/taxi-booking-app/#primaryimage"
                        },
                        "image": {
                              "@id": "https://www.nettechnocrats.com/taxi-booking-app/#primaryimage"
                        },
                        "thumbnailUrl": "https://www.nettechnocrats.com/wp-content/uploads/2023/09/main-taxi-1024x310-1.webp",
                        "datePublished": "2023-09-13T05:58:01+00:00",
                        "dateModified": "2024-08-13T11:20:22+00:00",
                        "description": "Looking for a top Taxi Booking App Development Company in India & USA? Nettechnocrats delivers custom solutions for your taxi app needs. Contact us now",
                        "breadcrumb": {
                        ...
                        "potentialAction": [{
                              "@type": "ReadAction",
                              "target": ["https://www.nettechnocrats.com/taxi-booking-app/"]
                        }]
                  }, {
                        "@type": "ImageObject",
                        "inLanguage": "en-US",
                        "@id": "https://www.nettechnocrats.com/taxi-booking-app/#primaryimage",
                        "url": "https://www.nettechnocrats.com/wp-content/uploads/2023/09/main-taxi-1024x310-1.webp",
                        "contentUrl": "https://www.nettechnocrats.com/wp-content/uploads/2023/09/main-taxi-1024x310-1.webp",
                        "width": 1024,
                        "height": 310,
                        "caption": "Taxi Booking"
                  }, {
                        "@type": "BreadcrumbList",
                        "@id": "https://www.nettechnocrats.com/taxi-booking-app/#breadcrumb",
                        "itemListElement": [{
                  ...
                  <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
                        <div class="col-xl-12 wow fadeInLeft">
                              <div class=" rounded d-flex justify-content-center">
                                    <img src="{{ asset('assets/web/taxi.webp') }}" class="img-fluid rounded" alt="Taxi Booking App Development" style="width: 100%; height:500px; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
                              </div>
                        </div>
                  </div>
            </div>
                  ...
                  <div id="call-to-action" class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100" style=" background-color: var(-accent-color) !important;">
                        ...
                        <div class="col-xl-6 wow fadeInLeft">
                              <div>
                                    ...
                                    <img src="{{ asset('assets/web/progress.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="Mobile App">
                              </div>
                        </div>
                        <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
