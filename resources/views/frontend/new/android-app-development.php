  ...
  <div class="container">
    <div class="row technology-top">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <h3 class="text-center andi">Android Application Development Services</h3>
        <p class="font-19 text-center">Develop your dream business ideas into reality</p>
      </div>
    </div>
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:-30px;">
        <div class="chatbot-channel-tab-outer android-tab">
          <ul class="nav nav-tabs tabtop  tabsetting">
            ...
            <li> <a href="#tab_default_5" data-toggle="tab"> Web-Based Applications</a> </li>
            <li> <a href="#tab_default_6" data-toggle="tab"> Multimedia Applications</a> </li>
            <li> <a href="#tab_default_7" data-toggle="tab"> Testing/Portability</a> </li>
            <li> <a href="#tab_default_8" data-toggle="tab"> App Upgrade</a> </li>
          </ul>
          <div class="tab-content margin-tops">
            <div class="tab-pane active  in" id="tab_default_1">
              <div class="col-md-12">
                <h4 class="heading4">Game Development</h4>
                <p>We can help you develop any kind of unique and fascinating Android game apps with rich backgrounds and stunning graphics. With stunning user interface & engaging features, our gaming apps for Android apps deliver astounding user experience.</p>
              </div>
            </div>
            <div class="tab-pane fade" id="tab_default_2">
              <div class="col-md-12">
                <h4 class="heading4">M-commerce Applications</h4>
                <p>Our team of dedicated Android app developers works efficiently to create fast and intuitive mobile apps so that you get maximum benefits in a minimum period. We create high-performing & compatible mobile apps with interactive features & functionalities. </p>
              </div>
            </div>
            <div class="tab-pane fade" id="tab_default_3">
              <div class="col-md-12">
                <h4 class="heading4">Utility Apps </h4>
                <p>Nettechnocrats also holds expertise in developing apps for Android leveraged with user-friendly features. Our sophisticated utility mobile apps that help Android devices reach their high potential and simplify everyday task with incredible accessibility.</p>
              </div>
            </div>
            <div class="tab-pane fade" id="tab_default_4">
              <div class="col-md-12">
                <h4 class="heading4">UI/UX Design</h4>
                <p>Our methodologies & techniques for Android app development revolve around a robust strategy to customize a compelling UI/UX design that not only looks unique and catchy but also engages users for an extended timeline. </p>
              </div>
            </div>
            <div class="tab-pane fade" id="tab_default_5">
              <div class="col-md-12">
                <h4 class="heading4">Web-based Applications</h4>
                <p>Our programmers code robust mobile apps for the web using Android SDK and framework APIs with in-depth knowledge of Java programming language. Being a leading Android app development agency, Nettechnocrats has been providing quality-based services for web-based applications using Android platform. </p>
              </div>
            </div>
            <div class="tab-pane fade" id="tab_default_6">
              <div class="col-md-12">
                <h4 class="heading4">Multimedia Applications</h4>
                <p>Keeping in mind custom client concepts, we build robust, scalable and stable Android apps with high user engagement for entertainment vertical. Our fully-functional multimedia apps run smoothly across varied Android devices for enhanced user engagement. </p>
              </div>
            </div>
            <div class="tab-pane fade" id="tab_default_7">
              <div class="col-md-12">
                <h4 class="heading4">Testing/Portability</h4>
                <p>Backed by a team of smart quality analysts, Nettechnocrats is renowned for its rock-solid plans & strategies for Android app development and testing. Our experts push their limits to meet clients’ expectations & provide organized results to analyze app’s performance & determine major issues before launch day. </p>
              </div>
            </div>
            <div class="tab-pane fade" id="tab_default_8">
              <div class="col-md-12">
                <h4 class="heading4">App Upgrade</h4>
                <p>Alongside developing apps for the Android platform, our team of professionals helps you in updating the apps that give you access to the advanced features and also improve the security and stability of your business apps.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <ul class="nav nav-tabs" role="tablist">
          <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#why_1">Mobile User Interface Design</a></li>
          <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#why_2">Robust Programming Skills</a></li>
          <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#why_3">Backend Computation</a></li>
          <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#why_4">Integration & Customization</a></li>
          <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#why_5">Business Expertise</a></li>
          <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#why_6">Flexible Work Approach</a></li>
        </ul>
...
<section class="section app-develop-sec" style="margin-top:-30px">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="appdevelop-left">
    ...
    <div class="row">
      <div class="col-lg-10 mx-auto">
        <div class="left_side">
          ...
          <p>Let's Connect to discuss your <strong>Android App Development</strong> project </p>
        </div>
