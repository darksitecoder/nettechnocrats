        ...
        <div class="row">
            <div class="col-md-12">
                <div class="app_heading iphone">
                    <h1>
                        <font>Android</font> App Design Services
                    </h1>
                ...
                <div class="col-md-4 col-xs-12">
                    <div class="row">
                        <div class="middleimg app-design">
                            <img src="https://s3.us-east-2.amazonaws.com/nettech-images/androidmiddle.webp" alt="image">
                        </div>
                    </div>
                </div>
...
<section class="whychooseus">
    <div class="leftimg">
        <img src="https://s3.us-east-2.amazonaws.com/nettech-images/whychoose.webp" alt="image">
    </div>
    <div class="container">
        <div class="row">
