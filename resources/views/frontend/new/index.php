...
<section class="top_banner">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item active"> <img src="images/web_develepment_new.jpg" alt="Website development">
        ...
        <div class="carousel-caption banner_txt">
          ...
          <a href="<?= BaseUrl ?>web-development.php">Learn more</a>
        </div>
      ...
      <div class="carousel-item"> <img src="images/mobile_app_banner_new.jpg" alt="Mobile App Development">
        ...
        <div class="carousel-caption banner_txt">
          ...
          <a href="<?= BaseUrl ?>mobile-app-development.php">Learn more</a>
        </div>
      ...
      <div class="carousel-item"> <img src="images/enterprise_banner_new.jpg" alt="Enterprise Software Development">
        ...
        <div class="carousel-caption banner_txt">
          ...
          <a href="<?= BaseUrl ?>enterprise-software-development.php">Learn more</a>
        </div>
      ...
      <div class="carousel-item"> <img src="images/main_banner.jpg" alt="Digital Marketing">
        ...
        <div class="carousel-caption banner_txt">
          ...
          <a href="<?= BaseUrl ?>digital-marketing.php">Learn more</a>
        </div>
  ...
  <div class="right_trust">
    ...
    <ul>
      ...
      <li><a href="https://clutch.co/profile/nettechnocrats" target="_blank"><img src="images/clutch_logo.webp" alt="trusted by clutch"></a></li>

      <li><a href="https://extract.co/nettechnocrats" target="_blank"><img src="images/extract_logo.webp" alt="trusted by extract"></a></li>

      <li><a href="https://www.goodfirms.co/companies/view/769/nettechnocrats-it-services-pvt-ltd" target="_blank"><img src="images/good_firms.webp" alt="trusted by good firms"></a></li>

      <li><a href="https://www.appfutura.com/developers/nettechnocrats1" target="_blank"><img src="images/app_futura.webp" alt="trusted by app flutra"></a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-10">
          ...
          <ul>
            ...
            <li><img src="images/cocacola.webp" alt="cocacola"></li>

            <li><img src="images/lexus.webp" alt="lexus"></li>

            <li><img src="images/preapps.webp" alt="preapps"></li>

            <li><img src="images/slim_browser.webp" alt="slim browser"></li>

            <li><img src="images/zangi.webp" alt="zangi"></li>

            <li><img src="images/dunlap.webp" alt="dunlap"></li>
      ...
      <div class="col-md-12">
        ...
        <ul>
          ...
          <li>
            ...
            <figure><img src="images/web_development_icon.webp" alt="Web Development"></figure>
          ...
          <li>
            ...
            <figure><img src="images/mobile_app_icon.webp" alt="Mobile Application"></figure>
          ...
          <li>
            ...
            <figure><img src="images/erp_icon.webp" alt="Enterprise Software"></figure>
          ...
          <li>
            ...
            <figure><img src="images/digital_marketing_icon.webp" alt="Digital Marketing"></figure>
      ...
      <div class="col-md-12">
        ...
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#real_estate">
              ...
              <figure><img src="images/real_estate.webp" alt="Real Estate"></figure>
          ...
          <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#healthcare">
              ...
              <figure><img src="images/healthcare_icon.webp" alt="Healthcare"></figure>
          ...
          <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#travel">
              ...
              <figure><img src="images/travel_icon.webp" alt="Travel & Tourism"></figure>
          ...
          <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#automotive">
              ...
              <figure><img src="images/automative_icon.webp" alt="Automotive"></figure>
          ...
          <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#retail">
              ...
              <figure><img src="images/retail_icon.webp" alt="Retail & E-commerce"></figure>
          ...
          <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#banking">
              ...
              <figure><img src="images/banking_icon.webp" alt="Banking & Finance"></figure>
          ...
          <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#media">
              ...
              <figure><img src="images/media_entertainment_icon.webp" alt="Media & Entertainment"></figure>
          ...
          <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#e_learning">
              ...
              <figure><img src="images/e_learning_icon.webp" alt="Education & E-Learning"></figure>
        ...
        <div class="tab-content">
          ...
          <div id="real_estate" class="container tab-pane active">
            ...
            <h3><a href="real-state-portal-development-company.php"><img src="images/real_estate2.webp" alt="Real Estate"> Real Estate</a></h3>
          ...
          <div id="healthcare" class="container tab-pane fade">
            ...
            <h3><a href="medical-healthcare-app-development.php"><img src="images/healthcare_icon_2.webp" alt="Healthcare"> Healthcare</a></h3>
          ...
          <div id="travel" class="container tab-pane fade">
            ...
            <h3><a href="tour-travel-app-development-company.php"><img src="images/travel_icon_2.webp" alt="Travel & Tourism"> Travel & Tourism</a></h3>
          ...
          <div id="automotive" class="container tab-pane fade">
            ...
            <h3><a href="automobile-software-solutions.php"><img src="images/automative_icon_2.webp" alt="Automotive"> Automotive</a></h3>
          ...
          <div id="retail" class="container tab-pane fade">
            ...
            <h3><a href="retailer-wholeseller.php"><img src="images/retail_icon_2.webp" alt="Retail & E-commerce"> Retail & E-commerce</a></h3>
          ...
          <div id="banking" class="container tab-pane fade">
            ...
            <h3><a href="finance-banking-software-development.php"><img src="images/banking_icon_2.webp" alt="Banking & Finance"> Banking & Finance</a></h3>
          ...
          <div id="media" class="container tab-pane fade">
            ...
            <h3><a href="media-advertisement.php"><img src="images/media_entertainment_icon_2.webp" alt="Media & Entertainment"> Media & Entertainment</a></h3>
          ...
          <div id="e_learning" class="container tab-pane fade">
            ...
            <h3><a href="education-portal-development.php"><img src="images/e_learning_icon_2.webp" alt="Education & E-Learning"> Education & E-Learning</a></h3>
      ...
      <div class="col-md-12">
        ...
        <ul>
          ...
          <li>
            ...
            <figure><img src="images/blockchain_tech_icon.webp" alt="Blockchain Technology"></figure>
          ...
          <li>
            ...
            <figure><img src="images/cloud_computing_icon.webp" alt="Cloud Computing"></figure>
          ...
          <li>
            ...
            <figure><img src="images/ar_icon.webp" alt="Augmented Reality Solutions"></figure>
          ...
          <li>
            ...
            <figure><img src="images/ui_ux_design_icon.webp" alt="UI/UX designs"></figure>
          ...
          <li>
            ...
            <figure><img src="images/iot_icon.webp" alt="Internet Of Things"></figure>
          ...
          <li>
            ...
            <figure><img src="images/artificial_integ_icon.webp" alt="Artificial Intelligence"></figure>
    ...
    <div class="row">
      ...
      <div class="column"> <a href="#" class="column-content cards-item icons--hover-white" style="height: 423px;">
          ...
          <div class="cards-wrapper">
            ...
            <figure class="cards-icon"> <img src="images/rei_pro_logo.webp" alt="REI Property Pro"> </figure>
      ...
      <div class="column"> <a href="#" class="column-content cards-item icons--hover-white" style="height: 423px;">
          ...
          <div class="cards-wrapper">
            ...
            <figure class="cards-icon"> <img src="images/revjolt_logo.webp" alt="revJOLT"> </figure>
      ...
      <div class="column"> <a href="#" class="column-content cards-item icons--hover-white" style="height: 423px;">
          ...
          <div class="cards-wrapper">
            ...
            <figure class="cards-icon"> <img src="images/astoria_logo.webp" alt="Astoria"> </figure>
      ...
      <div class="column"> <a href="#" class="column-content cards-item icons--hover-white" style="height: 423px;">
          ...
          <div class="cards-wrapper">
            ...
            <figure class="cards-icon"> <img src="images/zangi.webp" alt="ZANGI"> </figure>
      ...
      <div class="column"> <a href="#" class="column-content cards-item icons--hover-white" style="height: 423px;">
          ...
          <div class="cards-wrapper">
            ...
            <figure class="cards-icon"> <img src="images/twis_logo.webp" alt="TSIG TWMobile"> </figure>
      ...
      <div class="column"> <a href="#" class="column-content cards-item icons--hover-white" style="height: 423px;">
          ...
          <div class="cards-wrapper">
            ...
            <figure class="cards-icon"> <img src="images/dbl_logo.webp" alt="DBL LexFect"> </figure>
      ...
      <div class="column"> <a href="#" class="column-content cards-item icons--hover-white" style="height: 423px;">
          ...
          <div class="cards-wrapper">
            ...
            <figure class="cards-icon"> <img src="images/lakanto_logo.webp" alt="Lakanto"> </figure>
      ...
      <div class="column"> <a href="#" class="column-content cards-item icons--hover-white" style="height: 423px;">
          ...
          <div class="cards-wrapper">
            ...
            <figure class="cards-icon"> <img src="images/weely_voice_logo.webp" alt="Weekly Voice"> </figure>
            ...
            <div class="carousel-item active ">
              ...
              <div class="row">
                ...
                <div class="col-md-1 col-sm-1 col-xs-12 col-lg-1">
                  ...
                  <img src="images/test-client.webp" alt="Website development">
            ...
            <div class="carousel-item ">
              ...
              <div class="row">
                ...
                <div class="col-md-1 col-sm-1 col-xs-12 col-lg-1">
                  ...
                  <img src="images/test-client1.webp" alt="Website development">
            ...
            <div class="carousel-item ">
              ...
              <div class="row">
                ...
                <div class="col-md-1 col-sm-1 col-xs-12 col-lg-1">
                  ...
                  <img src="images/test-client5.webp" alt="Website development">
            ...
            <div class="carousel-item ">
              ...
              <div class="row">
                ...
                <div class="col-md-1 col-sm-1 col-xs-12 col-lg-1">
                  ...
                  <img src="images/test-client2.webp" alt="Website development">
            ...
            <div class="carousel-item ">
              ...
              <div class="row">
                ...
                <div class="col-md-1 col-sm-1 col-xs-12 col-lg-1">
                  ...
                  <img src="images/test-client4.webp" alt="Website development">
            ...
            <div class="carousel-item ">
              ...
              <div class="row">
                ...
                <div class="col-md-1 col-sm-1 col-xs-12 col-lg-1">
                  ...
                  <img src="images/test-client6.webp" alt="Website development">
            ...
            <div class="carousel-item ">
              ...
              <div class="row">
                ...
                <div class="col-md-1 col-sm-1 col-xs-12 col-lg-1">
                  ...
                  <img src="images/test-client7.webp" alt="Website development">
            ...
            <div class="carousel-item ">
              ...
              <div class="row">
                ...
                <div class="col-md-1 col-sm-1 col-xs-12 col-lg-1">
                  ...
                  <img src="images/test-client8.webp" alt="Website development">
            ...
            <div class="carousel-item ">
              ...
              <div class="row">
                ...
                <div class="col-md-1 col-sm-1 col-xs-12 col-lg-1">
                  ...
                  <img src="images/test-client9.webp" alt="Website development">
      ...
      <div class="col-md-12">
        ...
        <ul class="stats">
          ...
          <li>
            ...
            <figure><img src="images/chart_icon.webp" alt="7+ YEARS IN BUSINESS"></figure>
          ...
          <li>
            ...
            <figure><img src="images/chart_icon.webp" alt="700+ PROJECTS DELIVERED"></figure>
          ...
          <li>
            ...
            <figure><img src="images/chart_icon.webp" alt="2500+ PROJECTS DELIVERED"></figure>
          ...
          <li>
            ...
            <figure><img src="images/chart_icon.webp" alt="ISO CERTIFIED"></figure>
          ...
          <li>
            ...
            <figure><img src="images/chart_icon.webp" alt="100+ FULL-TIME EMPLOYEES"></figure>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-5">
        ...
        <figure><img src="images/customer_care.webp" alt="24 X 7 Customer Care"></figure>
