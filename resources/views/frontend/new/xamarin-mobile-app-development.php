        ...
        <div class="row">
            <div class="col-md-6">
                <div class="python_text">
                    <h3>Build truly native mobile apps using the <br>powerful Xamarin app development platform</h3>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="text-center">
                    <h1 class="python_heading">Xamarin <font> Development Services</font>
                    </h1>

                    <h4>Create cross-platform mobile apps for <font>iOS and Android with Xamarin</font>
                    </h4>
                    <p>Nettechnocrats help you navigate the entire project life-cycle with integrated tools for prototyping, testing, data services, data connectors, in-app feedback, app management, analytics and more. One of the simplest way to get started using Xamarin. It is used to create apps, and serve those apps to connected mobile devices. Our developer provides an accessible environment for creating mobile apps. </p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row top_margin">
            <div class="col-md-4 col-xs-12">
                <div class="pytn_box first">
                    ...
                    <h5>We are one of the leading Xamarin app development companies offering a comprehensive suite of Xamarin services and expertise. </h5>
                </div>
            </div>
            <div class="col-md-4 col-xs-12">
                <div class="pytn_box sec">
                    <h1>Xamarin UI/UX Design</h1>
                    <img src="https://s3.us-east-2.amazonaws.com/nettech-images/python-icon.webp">
                    <h5>Leveraging Xamarin UI our expert designers create elegant mobile apps with great user experience, customized for end clients.</h5>
                </div>
            </div>
            <div class="col-md-4 col-xs-12">
                <div class="pytn_box third">
                    <h1>Native-Like Apps </h1>
                    <img src="https://s3.us-east-2.amazonaws.com/nettech-images/paythonicon3.webp">
                    <h5>Our talent pool of experienced developers have rich expertise in developing 100% native user interfaces customized for each platform using Xamarin.</h5>
                </div>
            </div>
            <div class="col-md-4 col-xs-12">
                <div class="pytn_box first">
                    ...
                    <h5>Backed by an expert team of testing professionals, we drill down every used case on Xamarin test cloud and deliver end products that are beta tested for usability.</h5>
                </div>
            </div>
            <div class="col-md-4 col-xs-12">
                <div class="pytn_box sec">
                    <h1>Complete lifecycle solutions</h1>
                    <img src="https://s3.us-east-2.amazonaws.com/nettech-images/paythonicon9.webp">
                    <h5>The visual studio and Xamarin mobile lifecycle solution include all the pieces of your mobile development strategy.</h5>
                </div>
            </div>

            <div class="col-md-4 col-xs-12">
                <div class="pytn_box third">
                    <h1>Xamarin Service</h1>
...
<section id="paython1" class="paython2">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="text-center">
                    <h2 class="python_heading">Why Choose Our Xamarin<font> Development Services?</font>
                    </h2>

                    <p>Xamarin provides all the useful features of native app development platforms in order to create outstanding apps without their associated overhead and constraints.</p>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 col-xs-12">
                <div class="python_choosw">
                    <h3 class="why_most">High-Quality Compiled Code</h3>
                </div>

                <ul class="paytn_list">
                    <li>
                        <h5>High-Quality Compiled Code</h5>
                        <p>The compiled code offered by Xamarin is both dynamic and high-performing in nature. This helps programmers to create apps that deliver device-specific experiences across the different mobile platform.</p>
                    </li>
                    <li>
                        <h5>Supports Multiple Devices</h5>
                        <p>Along with major platforms, Xamarin also supports smartphones, tablets, and wearable devices. As the platform supports all the latest mobile devices, it becomes easier for programmers to create innovative mobile apps. </p>
                    </li>
            ...
            <div class="col-md-6 col-xs-12">
                <div class="python_choosw payton_sec">
                    <h3 class="why_most">HOW WE MAKE THEM SUCCEED WITH Xamarin!!</h3>
                </div>

                <ul class="paytn_list list1">
                    </li>
                    <li>
                        <h5>Facilitates Testing</h5>
                        <p>Generally, developers need to invest a lot of time to assess the mobile app's look. Xamarin test suites allow to automatically test the mobile app on 100 real devices in the cloud.
                        </p>
                    </li>
                    <li>
                        <h5>Allow Performance Monitoring</h5>
                        <p>Using Xamarin insights, the developers can monitor and improve the performance of the application. The tool is also used to rank the issues based on user impact and reach.</p>
                    </li>
