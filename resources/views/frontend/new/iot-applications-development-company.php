...
<section class="top-outer iot-top">
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-8">
        <div class="top-text">
          <h2>INTERNET OF THINGS (IoT)</h2>
          <p>Create quality apps with Internet of Things <span>to ensure your apps performs</span></p>
        </div>
      </div>
...
<section class="section iot-sec">
  <div class="container">
    <div class="iot-inner">
      <div class="iot-inner-top">
        ...
        <div class="row">
          <div class="col-md-8">
            ...
            <p>There are endless IOT app development company in India who can unlock the full potential of the business. And we at Nettechnocrats understand opportunities for value creation and symmetrically address the underlying challenges with Internet Of Things solutions.</p>
          </div>
          <div class="col-md-4">
      ...
      <div class="iot-inner-bot">
        <ul>
          <li>
            <p>Our innovative business models help business in improving productivity and operational excellence while achieving high-efficiency business value.</p>
          </li>
          <li>
        ...
        <div class="getintouch-btn"><a href="https://www.nettechnocrats.com/contact.php"><img src="images/getintouch-btn.png" alt="" width="155" height="42"></a></div>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <ul class="nav nav-tabs" role="tablist">
          <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#why_1">Full Range Of IoT Services</a></li>
          <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#why_2">IoT Architecture Consulting</a></li>
          <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#why_3">Integration & Implementation</a></li>
          <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#why_4">Smart Manufacturing</a></li>
          <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#why_5">Processing & Automation</a></li>
          <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#why_6">Device Management</a></li>
        ...
        <div class="tab-content">
          ...
          <h3>Full Range Of IoT Services</h3>
            <p>With the extensive expertise and IOT app development services our team fulfills client’s business needs. We also provide comprehensive support to efficiently develop sustainable and innovative solutions for new business models.</p>
          </div>
          <div id="why_2" class="container tab-pane fade">
            <figure> <img src="images/chart_icon.png"></figure>
              <h3>IoT Architecture Consulting </h3>
            <p>We validate the agility and stability of your business and provide iot developer guidance for IOT platform selection. We provide IOT app development with the latest trends of the industry.</p>
          </div>
          <div id="why_3" class="container tab-pane fade">
            <figure> <img src="images/chart_icon.png"></figure>
            <h3>Integration & Implementation </h3>
            <p>We provide innovative, end-to-end and real time solutions. We are the IOT solution provider. Using our expertise we identify communication requirements of IOT devices. IoT developer develops cloud for data and process integration donning IOT app development. 
</p>
          </div>
          <div id="why_4" class="container tab-pane fade">
            <figure> <img src="images/chart_icon.png"></figure>
          <h3>Smart Manufacturing</h3>
            <p>Our expert enables efficient and profound iot application development. Also, they provide assistance of IOT data and advanced analytics that help in making informed decisions.</p>
          </div>
          
          <div id="why_5" class="container tab-pane fade">
            <figure> <img src="images/chart_icon.png"></figure>
            <h3>Processing & Automation</h3>
            <p>To get real-time analysis and accurate data evaluation by leveraging the advantage of graphs, charts and dashboards, as an IoT solution provider we get a better insight into advanced and complex data. </p>
          </div>
          
          <div id="why_6" class="container tab-pane fade">
            <figure> <img src="images/chart_icon.png"></figure>
             <h4>Device Management</h4>
            <p>You get assistance with safe and reliable device management while providing constant updates and fixing bugs. </p>
          </div>
...
<section class="iot-service section">
  <div class="container">
    <div class="row iot-service-top why-iot">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <h3 class="text-center">Why Choose IoT Service?</h3>
        <p class="text-center font-17">IT industry pioneers are leveraging the benefits offered by IoT to execute new ideas by connecting things and people. Also with the IoT application development, they deliver new services to the market.</p>
      </div>
    </div>
