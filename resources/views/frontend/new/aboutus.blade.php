   ...
   <div class="container">
      <div class="row">
         <div class="col-md-12">
            <div class="howtowork">
               <h1>How We Work</h1>
               <p>We believe in being the incompatible ones to deliver technology, products, services and progressive consulting practices to help all the corporations associated with Nettechnocrats. As technology evolves every day, so does it's price. Ultimately, we strive hard to bring the efficient technical and marketing solutions to one and all of them at an affordable expense and assist them to continue accomplishment of their business goals through our services.</p>
               <h1 class="simp">A simple, iterative process.</h1>
               <ul>
                  <li>
                     <div class="outer_div">
                        <div class="learn">
                           <h3>Learn</h3>
                           <p>To understand the problem better and prepare for the upcoming stages of the cycle.</p>
                        </div>
                     </div>
                  </li>
                  <li>
                     <div class="outer_div">
                        <div class="learn">
                           <h3>Iterate</h3>
                           <p>To give and receive feedback easily in order to come up with an effective and lasting solution.</p>
                        </div>
                     </div>
                  </li>
                  <li>
                     <div class="outer_div">
                        <div class="learn">
                           <h3>Launch</h3>
                           <p>Your website to increase your company’s profitability at warp speed.</p>
                        </div>
                     </div>
                  </li>
               </ul>
         ...
         <div class="col-md-12">
            <div class="team_div client_div">
               ...
               <div class="brands_logo">
                  ...
                  <div class="logo_brands"> <img src="https://s3.us-east-2.amazonaws.com/nettech-images/client3.png" alt="" class="img-responsive" /> </div>
                  <div class="logo_brands"> <img src="https://s3.us-east-2.amazonaws.com/nettech-images/client4.png" alt="" class="img-responsive" /> </div>
                  <div class="logo_brands"> <img src="https://s3.us-east-2.amazonaws.com/nettech-images/client5.png" alt="" class="img-responsive" /> </div>
                  <div class="logo_brands"> <img src="https://s3.us-east-2.amazonaws.com/nettech-images/client6.png" alt="" class="img-responsive" /> </div>
                  <div class="logo_brands"> <img src="https://s3.us-east-2.amazonaws.com/nettech-images/client8.png" alt="" class="img-responsive" /> </div>
                  <div class="logo_brands"> <img src="https://s3.us-east-2.amazonaws.com/nettech-images/client9.png" alt="" class="img-responsive" /> </div>
               </div>
