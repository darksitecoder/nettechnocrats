...
<head>
 ...
 <title>Elevate Your Presence in the Healthcare Industry with a Top SEO Company</title>
    ...
    <div class="col-lg-6 content d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
     <div class="seo__animation__gifs">
      <div class="rounded-4 position-relative overflow-hidden">
       <img src="{{ asset('assets/web/healthcare-seo.webp') }}" class="img-fluid w-100 image-with-shadow" alt="">
