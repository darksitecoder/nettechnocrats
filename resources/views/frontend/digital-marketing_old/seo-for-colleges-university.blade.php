   ...
   <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="col-xl-5 wow fadeInRight" data-wow-delay="0.2s">
     <div class=" rounded position-relative overflow-hidden  d-flex justify-content-center">
      <img src="{{ asset('assets/web/college-seo.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="">
   ...
   <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
     <div class="rounded position-relative overflow-hidden">
      <img src="{{ asset('assets/web/college-seo-nettech.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="">
      ...
      <div id="collapseThree" class="tab-pane fade show p-0">
       <div class="row g-4">
        <div class="col-md-12">
         ...
         <p class="mb-4">Our team of qualified specialist makes us one of the best SEO companies. We bring out a cent per cent guaranteed result for clients and customers.</p>
        </div>
       </div>
      </div>
   ...
   <div class="row pt-2">
    ...
    <div class="col-lg-6 content d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
     <div class="seo__animation__gif">
      <div class="rounded position-relative overflow-hidden">
       <img src="{{ asset('assets/web/school-building-big-city-vector-illustration_61747-291.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="">
