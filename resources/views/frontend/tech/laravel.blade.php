...
<body>
   ...
   <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="col-xl-5 wow fadeInRight" data-wow-delay="0.2s">
     <div class=" rounded position-relative overflow-hidden  d-flex justify-content-center">
      <img src="{{ asset('assets/web/Laravel.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="Laravel Development Company">
 ...
 <div class="container-fluid about py-5">
  <div class="container py-5">
   ...
   <div class="text-center mx-auto pb-5 wow fadeInUp" data-aos="fade-up" data-aos-delay="100" style="max-width: 800px;">
    <h2 class="display-5 mb-4">Laravel Web Development Services</h2>
   ...
   <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
     <div class="rounded position-relative overflow-hidden">
      <img src="{{ asset('assets/web/laravel-mid.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="Laravel Development Company">
   ...
   <div class="row g-4">
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       <a href="#" class="h4 d-inline-block mb-4">LARAVEL DEVELOPMENT SERVICES</a>
       <p class="mb-4">Our Laravel developers create large-scale Laravel websites and applications incorporating the latest Laravel flavors.</p>
    ...
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       <a href="#" class="h4 d-inline-block mb-4">LARAVEL 3RD PARTY API INTEGRATIONS</a>
       <p class="mb-4">Our professionals offer easy Laravel API integration services to integrate your data with third-party applications which are specialized and customized to your needs.</p>
       <!-- <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a> -->
      </div>
     </div>
    </div>
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       <a href="#" class="h4 d-inline-block mb-4">SHOPPING CART DEVELOPMENT</a>
       <p class="mb-4">Our Laravel eCommerce development is based on the concept of creating a powerful eCommerce site enabling to create a full-featured store for online presence.</p>
       <!-- <a class="btn btn-primary rounded-pill py-2 px-4" href="#">Learn More</a> -->
      </div>
     </div>
    </div>
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       <a href="#" class="h4 d-inline-block mb-4">LARAVEL MIGRATION SOLUTION</a>
       <p class="mb-4">The emerging technologies like Laravel framework make it exceedingly easy to move your website from one host to another. Hire our Laravel developers to migrate your website and power up its performance in a fully managed environment.</p>
      </div>
     </div>
    </div>
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       ...
       <p class="mb-4">Laravel framework is a proven solution to get 3rd party app integration in the easiest possible way. Take a step ahead and connect with our developers to get an advanced feature riched 3rd party app integration in less time.</p>
      </div>
     </div>
    </div>
    <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
     <div class="service-item">
      ...
      <div class="rounded-bottom p-4">
       ...
       <p class="mb-4">Despite a user-friendly platform, there are chances that your Laravel apps can encounter some problems in a seamless performance. Don’t worry! Our adept professionals can help you to keep your website up-to-date by offering support and maintenance services post-development.</p>
      </div>
     </div>
    </div>
   </div>
 ...
 <section class="light-background why__choose__Net">
  <div class="container">
   <h2>Why Nettechnocrats for Laravel Development Services?</h2>
   ...
   <div class="row pt-2">
    ...
    <div class="col-lg-6 content d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
     <div class="seo__animation__gifs">
      <div class="rounded position-relative overflow-hidden">
       <img src="{{ asset('assets/web/laravel__hero.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="Laravel Development Service">
