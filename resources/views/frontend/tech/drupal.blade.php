    ...
    <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="col-xl-5 wow fadeInRight" data-wow-delay="0.2s">
        <div class=" rounded position-relative overflow-hidden  d-flex justify-content-center">
          <img src="{{ asset('assets/web/drupal.webp') }}" class="img-fluid rounded w-50 image-with-shadow" alt="Drupal Web Development Services">
    ...
    <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
        <div class="rounded position-relative overflow-hidden">
          <img src="{{ asset('assets/web/drupal-development.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="Drupal Web Development Services">
      ...
      <div class="col-xl-7 wow fadeInRight" data-wow-delay="0.4s">
        <div class="tab-content">
          <div id="collapseOne" class="tab-pane fade show p-0 active">
            <div class="row g-4">
              <div class="col-md-12">
                <h2 class="display-5 mb-4">Content Management Capability</h2>
          ...
          <div id="collapseTwo" class="tab-pane fade show p-0">
            <div class="row g-4">
              <div class="col-md-12">
                <h2 class="display-5 mb-4">No Licensing Fees</h2>
          ...
          <div id="collapseThree" class="tab-pane fade show p-0">
            <div class="row g-4">
              <div class="col-md-12">
                <h2 class="display-5 mb-4">Highly Flexible & Customizable</h2>
          ...
          <div id="collapseFour" class="tab-pane fade show p-0">
            <div class="row g-4">
              <div class="col-md-12">
                <h2 class="display-5 mb-4">Big Brand Trust On It</h2>
          ...
          <div id="collapseFive" class="tab-pane fade show p-0">
            <div class="row g-4">
              <div class="col-md-12">
                <h2 class="display-5 mb-4">Fast Deployment</h2>
          ...
          <div id="collapseSix" class="tab-pane fade show p-0">
            <div class="row g-4">
              <div class="col-md-12">
                <h2 class="display-5 mb-4">Search Engine Friendly</h2>
    ...
    <div class="row pt-2">
      ...
      <div class="col-lg-6 content d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
        <div class="seo__animation__gifs">
          <div class="rounded position-relative overflow-hidden">
            <img src="{{ asset('assets/web/drupal-nettechnocrats.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="Drupal Web Development">
