        ...
        <div class="col-xl-7 wow fadeInRight" data-wow-delay="0.4s">
          <div class="tab-content">
            <div id="collapseOne" class="tab-pane fade show p-0 active">
              <div class="row g-4">
                <div class="col-md-12">
                  <h2 class="display-5 mb-4">Open Source Infrastructure</h2>
            ...
            <div id="collapseTwo" class="tab-pane fade show p-0">
              <div class="row g-4">
                <div class="col-md-12">
                  <h2 class="display-5 mb-4">Robust & fast</h2>
            ...
            <div id="collapseThree" class="tab-pane fade show p-0">
              <div class="row g-4">
                <div class="col-md-12">
                  <h2 class="display-5 mb-4">Secure (No Direct Access)</h2>
            ...
            <div id="collapseFour" class="tab-pane fade show p-0">
              <div class="row g-4">
                <div class="col-md-12">
                  <h2 class="display-5 mb-4">Extension Library</h2>
            ...
            <div id="collapseFive" class="tab-pane fade show p-0">
              <div class="row g-4">
                <div class="col-md-12">
                  <h2 class="display-5 mb-4">eCommerce becomes easy</h2>
