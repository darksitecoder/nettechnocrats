   ...
   <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
    <div class="col-xl-6 wow fadeInLeft">
     <div>
      ...
      <p class="mb-4">Our certified Magento developers make sure to maintain the highest quality standards by using aesthetically pleasing plugins and extensions of Magento. No matter how big or small the project is, our Magento developers pay equal attention to all.</p>
