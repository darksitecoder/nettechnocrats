      ...
      <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="col-xl-5 wow fadeInRight" data-wow-delay="0.2s">
          <div class=" rounded position-relative overflow-hidden  d-flex justify-content-center">
            <img src="{{ asset('assets/web/mobile-wallet.webp') }}" class="img-fluid rounded w-100" alt="eWallet App Development Company">
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-fluid about py-5">
    <div class="container py-5">
      ...
      <div class="text-center mx-auto pb-5 wow fadeInUp" data-aos="fade-up" data-aos-delay="100" style="max-width: 800px;">
        <h2 class="display-5 mb-4">E-Wallet Application: Mobile wallet and its Type</h2>
      ...
      <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
        <div class="col-xl-12 wow fadeInLeft">
          <div>
            <!-- <h4 class="text-primary1">About Us</h4> -->
            <p class="mb-4 fw-bolder fs-4">Closed wallet:</p>
            <p class="mb-4">Closed wallets are connected to a broker or private business where you can only buy money directly from a single trader. One may not move money from these wallets to your bank account. Some of the example from the closed wallet is Amazon Pay and Ola Currency.</p>
            <p class="mb-4 fw-bolder fs-4">Semi-closed wallets :</p>
            <p class="mb-4">Many traders may use Semi-closed wallets to manage their payment gateway deal. You can receive money into your bank account in semi-closed wallets, but you cannot withdraw the money as money. Paytm, Freecharge, and Mobikwik are examples of wallets like these.</p>
            <p class="mb-4">On the other side, available wallets are not confined to the two others. Such a wallet shall also be issued by or to a third party directly by a bank. Any purchase can use the money in the pocket, and users can withdraw cash from their account. E.g., PayPal and Vodafone M-Pesa are mobile money wallets.</p>
            <p class="mb-4">With many types of eWallet options, there are vivid needs of client and customers. There are many firs that offer and fulfill the eWallet development needs, but if you are thinking to consider the best, add Nettechnocrats IT Services to your list.</p>
        ...
        <div class="col-lg-6 content d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
          <div class="seo__animation__gif">
            <div class="rounded-4 position-relative overflow-hidden">
              <img src="{{ asset('assets/web/android-image.webp') }}" class="img-fluid w-100" alt="eWallet App Development Company">
