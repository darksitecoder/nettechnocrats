   ...
   <div class="row g-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
     <div class=" rounded position-relative overflow-hidden  d-flex justify-content-center">
      <img src="{{ asset('assets/web/app-web-method.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="Methodology">
 ...
 <div class="container-fluid about py-0">
  <div class="container py-0">
   ...
   <div class="row g-5  align-items-center" data-aos="fade-up" data-aos-delay="100">
    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
     <div class="rounded position-relative overflow-hidden">
      <img src="{{ asset('assets/web/method1.webp') }}" class="img-fluid rounded w-100" alt="Methodology">
   ...
   <div class="row g-5 py-5 mt-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
     <div class="rounded position-relative overflow-hidden">
      <img src="{{ asset('assets/web/method2.webp') }}" class="img-fluid rounded w-100" alt="Methodology">
   ...
   <div class="row g-5 py-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
     <div class="rounded position-relative overflow-hidden">
      <img src="{{ asset('assets/web/method3.webp') }}" class="img-fluid rounded w-100" alt="Methodology">
   ...
   <div class="row g-5 py-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
     <div class="rounded position-relative overflow-hidden">
      <img src="{{ asset('assets/web/method4.webp') }}" class="img-fluid rounded w-100" alt="Methodology">
   ...
   <div class="row g-5 py-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
     <div class="rounded position-relative overflow-hidden">
      <img src="{{ asset('assets/web/method5-1.webp') }}" class="img-fluid rounded w-100" alt="Methodology">
   ...
   <div class="row g-5 py-5 align-items-center" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
     <div class="rounded position-relative overflow-hidden">
      <img src="{{ asset('assets/web/method6.webp') }}" class="img-fluid rounded w-100" alt="Methodology">
   ...
   <div class="row pt-2">
    ...
    <div class="col-lg-6 content d-flex align-items-center" data-aos="fade-up" data-aos-delay="200">
     <div class="seo__animation__gifs">
      <div class="rounded position-relative overflow-hidden">
       <img src="{{ asset('assets/web/app-mobile.webp') }}" class="img-fluid rounded w-100 image-with-shadow" alt="Methodology">
