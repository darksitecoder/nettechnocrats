...
var ActionsService = /*#__PURE__*/function () {
  ...
  return _createClass(ActionsService, null, [{
    ...
    value: function handleDropdown() {
      var selected = _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.size(_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.getSelectedItems());
    ...
    value: function handlePreview() {
      var selected = [];
      _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.each(_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.getSelectedFiles(), function (value) {
      ...
      if (_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.size(selected) > 0) {
    ...
    value: function handleCopyLink() {
      var links = '';
      _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.each(_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.getSelectedFiles(), function (value) {
        if (!_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.isEmpty(links)) {
          links += '\n';
        }
      ...
      _MessageService__WEBPACK_IMPORTED_MODULE_2__.MessageService.showMessage('success', _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.trans('clipboard.success'), _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.trans('message.success_header'));
    ...
    value: function handleGlobalAction(type, callback) {
      var selected = [];
      _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.each(_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.getSelectedItems(), function (value) {
        selected.push({
      ...
      switch (type) {
        ...
        case 'download':
          var files = [];
          _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.each(_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.getSelectedItems(), function (value) {
            if (!_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.inArray(_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.getConfigs().denied_download, value.mime_type)) {
              files.push({
                id: value.id,
                is_folder: value.is_folder
              });
          ...
          if (files.length) {
            ...
            _MessageService__WEBPACK_IMPORTED_MODULE_2__.MessageService.showMessage('error', _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.trans('download.error'), _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.trans('message.error_header'));
          }
          break;
        default:
    ...
    value: function processAction(data) {
      ...
      $.ajax({
        ...
        success: function success(res) {
          ...
          if (!res.error) {
            _MessageService__WEBPACK_IMPORTED_MODULE_2__.MessageService.showMessage('success', res.message, _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.trans('message.success_header'));
          } else {
            _MessageService__WEBPACK_IMPORTED_MODULE_2__.MessageService.showMessage('error', res.message, _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.trans('message.error_header'));
          }
          if (callback) {
            callback(res);
          }
    ...
    value: function renderActions() {
      ...
      if (hasFolderSelected) {
        actionsList.basic = _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.arrayReject(actionsList.basic, function (item) {
          return item.action === 'preview';
        });
        actionsList.basic = _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.arrayReject(actionsList.basic, function (item) {
          return item.action === 'crop';
        });
        actionsList.file = _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.arrayReject(actionsList.file, function (item) {
        ...
        if (!_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.hasPermission('folders.edit')) {
          actionsList.file = _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.arrayReject(actionsList.file, function (item) {
            return _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.inArray(['rename'], item.action);
          });
          actionsList.user = _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.arrayReject(actionsList.user, function (item) {
            return _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.inArray(['rename'], item.action);
          });
        }
        if (!_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.hasPermission('folders.trash')) {
          actionsList.other = _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.arrayReject(actionsList.other, function (item) {
            return _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.inArray(['trash', 'restore'], item.action);
          });
        }
        if (!_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.hasPermission('folders.destroy')) {
          actionsList.other = _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.arrayReject(actionsList.other, function (item) {
            return _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.inArray(['delete'], item.action);
          });
        }
        if (!_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.hasPermission('folders.favorite')) {
          actionsList.other = _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.arrayReject(actionsList.other, function (item) {
            return _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.inArray(['favorite', 'remove_favorite'], item.action);
          });
        }
      }
      ...
      _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.each(actionsList, function (action, key) {
        _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.each(action, function (item, index) {
          var is_break = false;
          switch (_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.getRequestParams().view_in) {
            case 'all_media':
              if (_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.inArray(['remove_favorite', 'delete', 'restore'], item.action)) {
                is_break = true;
              }
              break;
            case 'recent':
              if (_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.inArray(['remove_favorite', 'delete', 'restore', 'make_copy'], item.action)) {
                is_break = true;
              }
              break;
            case 'favorites':
              if (_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.inArray(['favorite', 'delete', 'restore', 'make_copy'], item.action)) {
                is_break = true;
              }
              break;
            case 'trash':
              if (!_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.inArray(['preview', 'delete', 'restore', 'rename', 'download'], item.action)) {
                is_break = true;
              }
              break;
          }
          if (!is_break) {
            var template = ACTION_TEMPLATE.replace(/__action__/gi, item.action || '').replace(/__icon__/gi, item.icon || '').replace(/__name__/gi, _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.trans('actions_list.' + key + '.' + item.action) || item.name);
      ...
      _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.each(_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.getConfigs().actions_list, function (actionGroup, key) {
        _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.each(actionGroup, function (value) {
          items[value.action] = {
            name: value.name,
            icon: function icon(opt, $itemElement, itemKey, item) {
              $itemElement.html('<i class="' + value.icon + '" aria-hidden="true"></i> ' + (_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.trans('actions_list.' + key + '.' + value.action) || item.name));
              return 'context-menu-icon-updated';
            },
            callback: function callback() {
  ...
  return _createClass(FolderService, [{
    ...
    value: function create(folderName) {
      ...
      $.ajax({
        ...
        success: function success(res) {
          if (res.error) {
            _MessageService__WEBPACK_IMPORTED_MODULE_2__.MessageService.showMessage('error', res.message, _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_3__.Helpers.trans('message.error_header'));
          } else {
            _MessageService__WEBPACK_IMPORTED_MODULE_2__.MessageService.showMessage('success', res.message, _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_3__.Helpers.trans('message.success_header'));
  ...
  return _createClass(MediaService, [{
    ...
    value: function refreshFilter() {
      ...
      if (viewIn === 'trash') {
        ...
        if (!_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.size(_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.getItems())) {
...
var MessageService = /*#__PURE__*/function () {
  ...
  return _createClass(MessageService, null, [{
    ...
    value: function showMessage(type, message) {
      ...
      switch (type) {
        case 'error':
          messageHeader = _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_0__.Helpers.trans('message.error_header');
          break;
        case 'success':
          messageHeader = _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_0__.Helpers.trans('message.success_header');
          break;
      }
    ...
    value: function handleError(data) {
      if (typeof data.responseJSON !== 'undefined' && !_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_0__.Helpers.isArray(data.errors)) {
  ...
  return _createClass(MediaDetails, [{
    ...
    value: function renderData(data) {
      ...
      if (useClipboard) {
        ...
        $('.js-btn-copy-to-clipboard').tooltip().on('mouseenter', function (event) {
...
var MediaList = /*#__PURE__*/function () {
  ...
  return _createClass(MediaList, [{
    ...
    value: function renderData(data) {
      ...
      template = template.replace(/__noItemIcon__/gi, _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_0__.Helpers.trans('no_item.' + view_in + '.icon') || '').replace(/__noItemTitle__/gi, _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_0__.Helpers.trans('no_item.' + view_in + '.title') || '').replace(/__noItemMessage__/gi, _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_0__.Helpers.trans('no_item.' + view_in + '.message') || '');
      var $result = $(template);
  ...
  return _createClass(MediaManagement, [{
    ...
    value: function handleMediaList() {
      ...
      _self.$body.off('click', '.js-media-list-title').on('click', '.js-media-list-title', function (event) {
        ...
        var $current = $(event.currentTarget);
        if (shift_key) {
          var firstItem = _App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.arrayFirst(_App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.getSelectedItems());
          if (firstItem) {
        ...
        if (data.is_folder === true) {
          ...
          if (!_App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.isUseInModal()) {
            ...
            if (_App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.size(selectedFiles) > 0) {
        ...
        if (!_App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.size(e.target.closest('.js-context-menu'))) {
    ...
    value: function handleModals() {
        ...
        _App_Services_ActionsService__WEBPACK_IMPORTED_MODULE_5__.ActionsService.processAction({
          ...
          if (!res.error) {
            ...
            $('#modal_rename_items .form-group').each(function (index, el) {
              var $current = $(el);
              if (_App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.inArray(res.data, $current.data('id'))) {
      ...
      _self.$body.off('submit', '.form-delete-items').on('submit', '.form-delete-items', function (event) {
        ...
        var items = [];
        var $form = $(event.currentTarget);
        _App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.each(_App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.getSelectedItems(), function (value) {
          items.push({
            id: value.id,
            is_folder: value.is_folder
          });
    ...
    value: function checkFileTypeSelect(selectedFiles) {
      if (typeof window.rvMedia.$el !== 'undefined') {
        var firstItem = _App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_1__.Helpers.arrayFirst(selectedFiles);
