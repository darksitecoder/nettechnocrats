...
class blogController extends Controller
{
    ...
    public function AddBlogsForAdmin(Request $request, $encryptedUserId, $page_type = null)
    {
        ...
        if ($role == 'b2b') {
            ...
            return view('admin_theme.pages.blogs.addBlogs', compact('role', 'b2b_shop_status', 'premium_features', 'encryptedUserId', 'page_type',));
        }
        return view('admin_theme/pages/blogs/addBlogs')->with(compact('role', 'encryptedUserId', 'page_type',));
    }
